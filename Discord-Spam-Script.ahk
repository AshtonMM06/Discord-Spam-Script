...
Loop {                      ; Add a number after "Loop" if you want it to loop a specific number of times
    Loop 100 {                ; The amount of messages it sends before waiting (default = 9)
    ...
    Sleep, 50             ; How long in milliseconds it will wait before it starts sending messages again
    if not SpamLoop
        break
}
